package com.inditex.service.rest.exception;
...
import com.inditex.service.exception.PricesNotFoundException;
import com.inditex.service.rest.exception.model.RestError;

@ControllerAdvice(basePackages = "com.inditex.service.rest.controller")
public class RestResponseExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleSpaceCraftNotFound(RuntimeException ex, WebRequest request) {
		String bodyOfResponse = "Prices not found";
